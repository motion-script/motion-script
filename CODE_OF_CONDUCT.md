...
We want Motion Script to be a welcoming, friendly, and productive community for
everyone. We pledge to make participation in the project a positive experience
for all, regardless of background or identity.

## Our standards

Behavior that helps build a healthy community includes:

- Being kind, respectful, and patient with others.
- Welcoming newcomers and helping them get started.
- Giving and gracefully accepting constructive feedback.
- Focusing on what is best for the project and the community.
- Showing empathy and assuming good intent.

Behavior that is not acceptable includes:

- Personal attacks, insults, or demeaning comments.
- Unwelcome personal attention or contact after being asked to stop.
...
- Any conduct that a reasonable person would find inappropriate in a
...
Maintainers are responsible for clarifying these standards and may take fair
corrective action in response to behavior they deem inappropriate, including
editing or removing contributions, and temporarily or permanently restricting
participation.
