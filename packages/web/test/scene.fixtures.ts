...
/**
 * The local scene builder these tests are written against.
 *
 * They exist to prove the **browser platform** draws what it is given — surfaces,
 * decode, pixel parity — so what they need is a tree and some motion over it,
 * not a document. The document model is verified where it lives, in core's own
 * tests; here it would only bury the thing under test in rows.
 *
