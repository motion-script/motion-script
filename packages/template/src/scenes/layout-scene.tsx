        ...
        this.add(
            <>
                <Rect gap={20} group={'row'} padding={10} width={1000} height={600}>
                    <Rect ref={colA} width={'fill'} flex={1} fill={'card'} borderRadius={8} />
                    <Rect group={'column'} gap={20} height={'fill'} width={'fill'} flex={2} >
                        ...
                        <Rect ref={rowB} height={'fill'} flex={1} fill={'card'} borderRadius={8} />

                    </Rect>
                    {/* flex implies width 'fill'; this column takes 1 share like the red one */}
                    <Rect ref={colB} flex={2} fill={'card'} borderRadius={8} />
                </Rect>
            </>,
        );
        yield* parallel(
