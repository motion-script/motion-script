...
export default createScene(function* (stage) {
    ...
    stage.add(<Polygon shadow={{ fill: 'black', dx: 20, dy: -20, blur: 20 }} fill={Fills.color('red', { opacity: 0.4 })} height={h} width={w} cornerRadius={20} />);
    stage.add(<Polygon shadow={[{ fill: 'black', dx: 20, dy: -20, blur: 10 }, { fill: 'black', dx: 40, dy: 20, blur: 10 }]} stroke={[{ weight: 2, fill: 'red' }, { weight: 8, fill: 'red', dash: 20, align: 'center' }]} height={h} width={w} cornerRadius={20} />);
