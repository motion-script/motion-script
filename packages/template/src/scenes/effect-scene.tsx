...
import { Scene, createRef, Reference, Text, Rect, Ellipse, Image, ShapeNode, Grid, FX, EffectChain, easeOutQuad, Fill } from "@motion-script/core";
...
export class EffectScene extends Scene {
    *build() {
        ...
        // (backgroundBlur, zoom) need content *behind* the affected node, so this
                    ...
                    <Rect borderRadius={16} width={'fill'} height={'fill'} clip={true}>
                        {background ? (
                            <Rect width={'fill'} height={'fill'}>
                                <Image src={'./cat.jpg'} fit={'fit'} width={'hug'} height={'fill'} >
                                    <Ellipse ref={ref} fill={'red'} width={'fill'} height={'fill'} effects={effect} />
