import type { InsetsResolved, Measurer, RenderContext } from "@motion-script/core";
 ...
 */
function gutterGapOf(scope: Measurer | RenderContext, m: CodeMetrics, cache: TokenAdvanceCache): number {
