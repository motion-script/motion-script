...
import { CanvasRenderContext2D, ContextMap, Graphics2D, ManifestAssetCatalog, Node2D, DefaultTextStyle, type Node, type RenderContext2D, type TextState } from '@motion-script/core';
...
class RecorderContext extends CanvasRenderContext2D {
...
/** A minimal `Measurer2D` — `Code` only asks for advance widths. */
