...
/** A satellite node's `center` pinned to the card's `centerLeft` anchor, following it as the card grows. */
export default createScene(function* (stage) {
    ...
    stage.add(
        <Rect width={'fill'} height={'fill'} flow={'freeform'} align={{ x: 0, y: 0 }}>
            ...
            <Rect width={20} height={20} cornerRadius={10} fill={'primary'} center={() => card().centerLeft} />
        </Rect>,
    );
