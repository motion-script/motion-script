...
/** {@link Rect} `group={'row'}`: three children laid left-to-right, with the gap animating wider. */
export default createScene(function* (stage) {
    stage.set({ fill: 'bg' });
    const row = createRef<Rect>();
    stage.add(
        <Rect ref={row} width={700} height={220} group={'row'} gap={8} center={() => stage.root.center}>
