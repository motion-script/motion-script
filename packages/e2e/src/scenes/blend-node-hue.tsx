...
/** Node-level `blend`: a magenta circle isolates and blends against a cyan backdrop via `'hue'`, taking the circle's hue while keeping the backdrop's saturation and luminosity. */
