 ...
 * size) and is placed against the **canvas** instead, so its `x`/`y` read as
 ...
 * - `'absolute'` — children are pinned to the canvas. This node still *owns* them
 ...
 * - `'absolute'` — pin to the canvas even inside a relative container.
 *
