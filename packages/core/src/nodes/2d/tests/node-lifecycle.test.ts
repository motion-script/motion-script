...
/** A leaf that exposes the box its parent laid it into (protected `layoutBounds` seam). */
...
function driveWithLayout<T>(
    ...
    const layout = () => {
        ...
        // layoutBounds, exactly as a parent packing it to size would.
