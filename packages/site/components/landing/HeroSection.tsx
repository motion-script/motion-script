  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center px-4 sm:px-6 lg:px-8 md:pt-16">
      ...
      <div className="relative z-30 mx-auto max-w-5xl text-center">
        <h1
          className="hero-fade-up sm:mt-12 font-serif text-foreground"
        ...
        <div className="hero-fade-up flex justify-center mb-4" style={{ animationDelay: '0.5s' }}>
        ...
        <p
          className="hero-fade-up mt-6 text-base sm:text-lg text-muted-foreground max-w-2xl mx-auto leading-relaxed"
        ...
        <div className="hero-fade-up mt-8 flex items-center justify-center gap-4" style={{ animationDelay: '0.9s' }}>
          <a
            href="/docs/intro"
        ...
        <div className="hero-fade-up mt-10 flex justify-center" style={{ animationDelay: '1.1s' }}>
          <CreateTerminal />
        </div>
      </div>

      <div className="hero-fade-in absolute bottom-8 left-1/2 -translate-x-1/2 z-30" style={{ animationDelay: '1.5s' }}>
        <div className="scroll-bounce w-6 h-10 rounded-full border-2 border-border flex items-start justify-center p-1.5">
