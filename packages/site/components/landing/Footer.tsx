    ...
    <footer className="border-t border-border py-12 px-4 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-7xl">
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="flex items-center gap-6 pr-32 text-sm text-muted-foreground">
            <Link href="/api/core" className="hover:text-foreground transition-colors no-underline hover:no-underline">
              API
            </Link>
            <Link href="/docs/intro" className="hover:text-foreground transition-colors no-underline hover:no-underline">
              Docs
            </Link>
            <Link href="/blog" className="hover:text-foreground transition-colors no-underline hover:no-underline">
              Blog
            </Link>
          </div>
          ...
          <div className="flex items-center gap-3">
            <a
              ...
              className="w-8 h-8 rounded-lg bg-foreground/5 border border-border flex items-center justify-center text-muted-foreground hover:text-foreground hover:bg-foreground/10 transition-all no-underline"
              aria-label="GitHub"
            >
