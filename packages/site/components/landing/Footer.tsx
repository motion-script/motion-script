        ...
        <div className="flex flex-col md:flex-row gap-12 md:gap-8">
          ...
          <div className="flex-1">
            ...
            <p className="text-sm text-muted-foreground max-w-xs">
              Open-source motion design tool for the web. Create stunning animations with code.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2.5">
              <li>
                <Link href="/docs/intro" className="text-sm text-muted-foreground hover:text-foreground transition-colors no-underline hover:no-underline">
                  Documentation
                </Link>
              </li>
              <li>
                <Link href="/api/core" className="text-sm text-muted-foreground hover:text-foreground transition-colors no-underline hover:no-underline">
                  API Reference
                </Link>
              </li>
              <li>
                <Link href="/blog" className="text-sm text-muted-foreground hover:text-foreground transition-colors no-underline hover:no-underline">
                  Blog
                </Link>
              </li>
              <li>
                <a
                  href="https://github.com/motion-script/motion-script/releases"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-sm text-muted-foreground hover:text-foreground transition-colors no-underline hover:no-underline"
                >
                  Changelog
                </a>
              </li>
