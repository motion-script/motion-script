...
`easeOut('back')` overshoots slightly and settles back, giving the motion a bit of life. `easeOut`, `easeIn`, and `easeInOut` each take the name of a curve — `'quad'`, `'cubic'`, `'back'`, `'elastic'`, and more. Try swapping them in and out to see how the feel changes.
