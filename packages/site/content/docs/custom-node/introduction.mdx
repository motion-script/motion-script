...
* **2D figures**, with the [Graphics](./graphics/overview) API. Shapes, paints, cuts and masks recorded into one list.
* **3D scenes**, with the [3D Graphics](./graphics-3d/overview) API. Meshes, lights and a camera.
...
* [Graphics](./graphics/overview) for the 2D drawing API.
* [3D Graphics](./graphics-3d/overview) for meshes, lights and cameras.
