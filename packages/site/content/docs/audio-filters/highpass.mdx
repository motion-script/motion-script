...
```tsx
import { Sound, AudioFilters, tween, lerpNumber } from 'motion-script';
...
- High-pass and low-pass filters can be chained to form a band-pass: `AudioFilters.highpass(200).lowpass(3000)`.
