...
```tsx
import { createScene, Ellipse, Effects, tween } from 'motion-script';
...
```tsx
import { createScene, Ellipse, Effects, tween, lerpNumber, easeIn } from 'motion-script';
