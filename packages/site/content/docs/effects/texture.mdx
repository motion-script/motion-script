...
[`Presets.paper`](./presets) wraps this with grain and a warm tint. It's the template for the whole material family — the same recipe with a weave, denim or felt image *is* canvas, denim or felt.
