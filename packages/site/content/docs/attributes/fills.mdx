...
It composes with the effect layer rather than duplicating it — [duotone](../effects/duotone) over it is marble, [threshold](../effects/threshold) over it is an organic matte, [posterize](../effects/posterize) over it is topographic banding, and [displace](../effects/displace) is water.
