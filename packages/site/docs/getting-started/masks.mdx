...
import { Scene, MaskGroup, Ellipse, Rect, Text } from '@motion-script/core';
...
```tsx title="src/scenes/my-scene.ts"
import { Scene, MaskGroup, Ellipse, Rect, Text, createRef, easeInOut } from '@motion-script/core';
...
```tsx title="src/scenes/my-scene.ts"
import { Scene, MaskGroup, Text, Rect, Fills } from '@motion-script/core';
