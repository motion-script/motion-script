    ...
    *build() {
        ...
        this.add(<Rect gap={40} width={'fill'} height={'fill'} group={'column'}>
            <Rect width={'fill'} height={'fill'} gap={40}>
                ...
                <Rect borderRadius={20} width={'fill'} height={'fill'} fill={cardColor} >
                    <Rect width={400} height={400} borderRadius={20} stroke={{ fill: 'orange', weight: 10 }} padding={40}>
                        <Text ref={autoFitText} text={'Hello world!'} fill={'white'} fontSize={'autofit'} wrap={true} minFontSize={40} />
                    </Rect>
                </Rect>
            </Rect>
            <Rect width={'fill'} height={'fill'} gap={40}>
                <Rect borderRadius={20} width={'fill'} height={'fill'} group={'column'} gap={20} fill={cardColor} padding={20}>
